...
int main ()
{
	...
	cout << "Money spent on clothes:" << (5 * hpw *payrate * 0.14) - (5 * hpw *payrate * 0.14 * .1) << endl; 
	cout << "Money spent on school supplies:" << (5 * hpw *payrate * 0.14) - (5 * hpw *payrate * 0.14 * .01) << endl;
	cout << "Money spent on savings bonds:" << (5 * hpw *payrate * 0.14) - (5 * hpw *payrate * 0.14 * .25) << endl;
